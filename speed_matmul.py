...
print("torch:      ", timeit.timeit(lambda: A_torch @ B_torch, number=n))
print("cuda best:  ", timeit.timeit(lambda: A_cuda @ B_cuda, number=n))
print("cuda tiled: ", timeit.timeit(lambda: A_cuda_tiled @ B_cuda_tiled, number=n))
print("cuda simple:", timeit.timeit(lambda: A_cuda_simple @ B_cuda_simple, number=n))
print("numpy:      ", timeit.timeit(lambda: A_np @ B_np, number=n))
# print("cpu:        ", timeit.timeit(lambda: A_cpu @ B_cpu, number=n))

''' > python3 speed_matmul.py 
(2048, 2048) @ (2048, 2048) repeat 100
torch:       0.7199447740022151
cuda best:   1.801550069998484
